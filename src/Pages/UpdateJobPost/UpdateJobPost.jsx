    ...
    return (
        <div className="bg-teal-50 lg:p-20 md:p-10 p-4">
            ...
            <form onSubmit={handleAddJob}>
                ...
                <div>
                    <div className="mt-6">
                        <input type="submit" value="Update Data" className="py-2 font-bold w-full bg-white border-2 border-teal-500 cursor-pointer hover:bg-teal-500 hover:text-white" data-aos="fade-up" />
                    </div>
                </div>
